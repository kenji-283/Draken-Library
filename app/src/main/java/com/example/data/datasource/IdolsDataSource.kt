...
/**
 * Fuente de datos estática para el Salón de los Ídolos de Draken's Library.
 * Permite registrar y modificar manualmente los autores favoritos directamente en el código fuente.
 */
object IdolsDataSource {

    val IDOLS: List<IdolAuthor> = listOf(
        IdolAuthor(
            id = "idol-nietzsche",
            nombre = "Friedrich Nietzsche",
            rutaDeFoto = "img_idol_nietzsche",
            epoca = "1844 - 1900",
    ...
    fun getById(id: String): IdolAuthor? {
